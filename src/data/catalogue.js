...
export const vehicles = [
  ...
  },
  {
    ...
    batteries: [
      ...
      // MSB — batteries étanches (AGM/VRLA, décharge lente). Prix à définir
      // (affichés « Sur demande »). Sept références ont la photo et la
      ...
      { id: 'so_msb_12v60', brand: 'MSB', model: 'LPCG12-60', ah: 60, v: 12, cca: 0, dim: '', price: 1600, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_lpcg1260.webp' },
      { id: 'so_msb_12v55', brand: 'MSB', model: 'LPC12-55', ah: 55, v: 12, cca: 0, dim: '229 × 138 × 213 mm', price: 1250, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_lpc1255.webp' },
      { id: 'so_msb_ldc1253', brand: 'MSB', model: 'LDC12-53', ah: 53, v: 12, cca: 0, dim: '229 × 138 × 213 mm', price: 1200, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1253.webp' },
      { id: 'so_msb_12v50', brand: 'MSB', model: '12V 50Ah', ah: 50, v: 12, cca: 0, dim: '229 × 138 × 213 mm', price: 1150, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1253.webp' },
      { id: 'so_msb_ldc1244', brand: 'MSB', model: 'LDC12-44', ah: 44, v: 12, cca: 0, dim: '197 × 165 × 170 mm', price: 1150, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1244.webp' },
      { id: 'so_msb_12v40', brand: 'MSB', model: '12V 40Ah', ah: 40, v: 12, cca: 0, dim: '197 × 165 × 170 mm', price: 1100, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1244.webp' },
      { id: 'so_msb_ldc1239', brand: 'MSB', model: 'LDC12-39', ah: 39, v: 12, cca: 0, dim: '196 × 130 × 169 mm', price: 950, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1239.webp' },
      { id: 'so_msb_12v36', brand: 'MSB', model: '12V 36Ah', ah: 36, v: 12, cca: 0, dim: '196 × 130 × 169 mm', price: 900, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1239.webp' },
      { id: 'so_msb_lp1228h', brand: 'MSB', model: 'LP12-28H', ah: 28, v: 12, cca: 0, dim: '', price: 800, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_lp1228h.webp' },
      { id: 'so_msb_12v26', brand: 'MSB', model: 'MS 12-26 ULTRA', ah: 26, v: 12, cca: 0, dim: '166 × 175 × 125 mm', price: 750, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ms1226.webp' },
      { id: 'so_msb_12v25', brand: 'MSB', model: 'LDC12-25', ah: 25, v: 12, cca: 0, dim: '166 × 175 × 125 mm', price: 600, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1225.webp' },
      { id: 'so_msb_12v20', brand: 'MSB', model: 'LPC12-20', ah: 20, v: 12, cca: 0, dim: '181 × 77 × 167 mm', price: 550, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_lpc1220.webp' },
      { id: 'so_msb_12v18', brand: 'MSB', model: 'MS 12-18', ah: 18, v: 12, cca: 0, dim: '181 × 76 × 167 mm', price: 450, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ms1218.webp' },
      { id: 'so_msb_12v15', brand: 'MSB', model: 'LDC12-15', ah: 15, v: 12, cca: 0, dim: '181 × 76 × 167 mm', price: 380, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ldc1215.webp' },
      { id: 'so_msb_12v12', brand: 'MSB', model: 'LPC12-12', ah: 12, v: 12, cca: 0, dim: '151 × 98 × 95 mm', price: 300, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_lpc1212.webp' },
      { id: 'so_msb_ms1212', brand: 'MSB', model: 'MS 12-12', ah: 12, v: 12, cca: 0, dim: '151 × 98 × 95 mm', price: 320, fits: 'Kit solaire, onduleur (décharge lente)', photo: '/batteries/msb_ms1212.webp' },
      { id: 'so_msb_12v9', brand: 'MSB', model: 'MS 12-9', ah: 9, v: 12, cca: 0, dim: '151 × 65 × 94 mm', price: 200, fits: 'Onduleur, alarme, backup', photo: '/batteries/msb_ms129.webp' },
