...
export const vehicles = [
  ...
  },
  {
    ...
    batteries: [
      ...
      // EXIDE moto — specs réelles (V/Ah/A) et prix promo (captures client) ; dimensions estimées d'après le type/format (à confirmer).
      { id: 'exgel30', brand: 'EXIDE', model: 'GEL 12-30', ah: 30, v: 12, cca: 250, dim: '197 × 132 × 186 mm', price: 1800, fits: 'Gros custom, Harley (Gel)', photo: '/batteries/exgel30.webp' },
      { id: 'exgel19', brand: 'EXIDE', model: 'GEL 12-19', ah: 19, v: 12, cca: 170, dim: '186 × 82 × 171 mm', price: 1350, fits: 'Custom, gros scooter (Gel)', photo: '/batteries/exgel19.webp' },
      { id: 'exgel16', brand: 'EXIDE', model: 'GEL 12-16', ah: 16, v: 12, cca: 100, dim: '181 × 77 × 167 mm', price: 1250, fits: 'Moto route, custom (Gel)', photo: '/batteries/exgel16.webp' },
      { id: 'exagm23', brand: 'EXIDE', model: 'AGM 12-23', ah: 21, v: 12, cca: 350, dim: '205 × 87 × 162 mm', price: 1400, fits: 'Gros custom, Harley (Y50-N18)', photo: '/batteries/exagm23.webp' },
      { id: 'exagm16', brand: 'EXIDE', model: 'AGM 12-16', ah: 16, v: 12, cca: 170, dim: '175 × 87 × 155 mm', price: 1200, fits: 'YTX16 — moto, jet-ski (AGM)', photo: '/batteries/exagm16.webp' },
      { id: 'exagm14', brand: 'EXIDE', model: 'AGM 12-14', ah: 12, v: 12, cca: 210, dim: '150 × 87 × 145 mm', price: 950, fits: 'YTX14 — moto, quad (AGM)', photo: '/batteries/exagm14.webp' },
      { id: 'exagm12', brand: 'EXIDE', model: 'AGM12-12', ah: 12, v: 12, cca: 200, dim: '150 × 87 × 110 mm', price: 950, fits: 'YTX12 — moto / batterie auxiliaire (AGM)', photo: '/batteries/exagm12.webp' },
      { id: 'exagm9', brand: 'EXIDE', model: 'AGM 12-9', ah: 9, v: 12, cca: 120, dim: '150 × 87 × 105 mm', price: 600, fits: 'YTX9 — moto, scooter (AGM) — prix à confirmer', photo: '/batteries/exagm9.webp' },
      { id: 'exetx9c', brand: 'EXIDE', model: 'ETX9C-BS AGM', ah: 9, v: 12, cca: 120, dim: '150 × 87 × 105 mm', price: 430, fits: 'YTX9-BS — moto, scooter (AGM)', photo: '/batteries/exetx9c.webp' },
      { id: 'exeb9b', brand: 'EXIDE', model: 'EB9-B', ah: 9, v: 12, cca: 120, dim: '137 × 76 × 141 mm', price: 600, fits: 'YB9-B — moto classique', photo: '/batteries/exeb9b.webp' },
      { id: 'exagm8', brand: 'EXIDE', model: 'AGM 12-8', ah: 8.6, v: 12, cca: 145, dim: '150 × 87 × 93 mm', price: 600, fits: 'YTZ8 / YTX7 — scooter (AGM)', photo: '/batteries/exagm8.webp' },
      { id: 'exetx5l', brand: 'EXIDE', model: 'ETX5L-BS AGM', ah: 4, v: 12, cca: 70, dim: '114 × 71 × 106 mm', price: 230, fits: 'YTX5L — scooter, petite moto (AGM)', photo: '/batteries/exetx5l.webp' },
      { id: 'exagm4', brand: 'EXIDE', model: 'AGM 12-4', ah: 3, v: 12, cca: 50, dim: '114 × 71 × 87 mm', price: 220, fits: 'YTX4L — petite moto, scooter (AGM)', photo: '/batteries/exagm4.webp' },
      { id: 'ex6n4b', brand: 'EXIDE', model: '6N4B-2A', ah: 4, v: 6, cca: 35, dim: '103 × 57 × 111 mm', price: 136, fits: 'Motos anciennes 6V, mobylette', photo: '/batteries/ex6n4b.webp' },
    ],
  },
  {
    key: 'camion',
