...
const PATHS = {
  ...
  // Jet-ski / scooter des mers (coque + guidon + vaguelettes)
  jetski:
    'M4.5 15l2-3.5h6.5l3 2.5 3.5.5-1.2 3H6.5zM12.5 12V8.2l3.2-1.2M3 18.9c1.3 0 1.3 1 2.6 1s1.3-1 2.6-1 1.3 1 2.6 1 1.3-1 2.6-1 1.3 1 2.6 1 1.3-1 2.6-1',
